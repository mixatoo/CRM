    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'travelers/:travelerId', element: <Navigate to="overview" replace /> },
          { path: 'travelers/:travelerId/:tab', element: <TravelerWorkspacePage /> },
          ...
          { path: 'transfers/:transferId', element: <Navigate to="route" replace /> },
          { path: 'transfers/:transferId/:tab', element: <TransferWorkspacePage /> },
