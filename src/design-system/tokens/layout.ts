...
export const layout = {
  ...
  pageContent: 'px-3 py-3 sm:px-6 sm:py-6 lg:px-8',
  /** Full-height list/workspace shells: tighter vertical, same horizontal rhythm */
  pageViewport: 'px-2 py-2 sm:px-4 sm:py-3 lg:px-6 lg:py-4',
  ...
  toolbar: 'px-2 py-2 sm:px-4 lg:px-6',
  pageTitle: 'text-base font-normal tracking-tight text-[var(--color-foreground)] sm:text-lg',
  sectionTitle: 'text-caption font-normal uppercase tracking-wide text-[var(--color-muted)]',
  cardTitle: 'text-sm font-normal text-[var(--color-accent)] sm:text-base',
  entityTitle: 'text-sm font-normal text-[var(--color-foreground)] sm:text-base',
  body: 'text-sm text-[var(--color-foreground)]',
  caption: 'text-xs text-[var(--color-muted)]',
  stat: 'text-xl font-normal tabular-nums text-[var(--color-accent)] sm:text-2xl',
