...
import { TripFlightOperationsTab } from '@/features/trips/components/services/flight/TripFlightOperationsTab'
...
export function TripFlightOperationsPage() {
  ...
  return (
    ...
    >
      {trip && service ? <TripFlightOperationsTab trip={trip} service={service} /> : null}
    </TripWorkspaceLayout>
  )
}
