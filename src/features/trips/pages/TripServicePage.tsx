...
import { TripServiceDetailTab } from '@/features/trips/components/services/TripServiceDetailTab'
...
export function TripServicePage() {
  ...
  if (!isLoading && service && service.category === 'flight') {
    return <Navigate to={`/trips/${tripId}/services/${serviceId}/flight`} replace />
  }
  ...
  return (
    ...
    >
      {trip && service ? <TripServiceDetailTab trip={trip} service={service} /> : null}
    </TripWorkspaceLayout>
  )
}
