...
import { TRIP_PIPELINE_STAGES, TRIP_STAGES } from '@/domain/entities'
import { TRIP_SERVICE_STATUSES } from '@/domain/entities/trip-service'
...
import { SERVICE_CATEGORY_LABELS, SERVICE_CATEGORIES } from '@/domain/entities'
