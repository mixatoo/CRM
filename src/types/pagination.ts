...
export const TRAVELERS_PAGE_SIZE_STORAGE_KEY = 'egyliere.travelers.pageSize'

export const CLIENT_LINKED_TRIPS_PAGE_SIZE_STORAGE_KEY = 'egyliere.clients.linked-trips.pageSize'
